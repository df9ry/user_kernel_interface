...
/**
 * @bref list_for_each	-	iterate over a list
...
/**
 * @brief hlist_for_each_entry	- iterate over list of given type
 * @param pos	the type * to use as a loop cursor.
 * @param head	the head for your list.
...
/**
 * @brief hlist_for_each_entry_continue - iterate over a hlist continuing after current point
 * @param pos	the type * to use as a loop cursor.
 * @param member	the name of the hlist_node within the struct.
 */
...
/**
 * @brief hlist_for_each_entry_from - iterate over a hlist continuing from current point
 * @param pos	the type * to use as a loop cursor.
 * @param member	the name of the hlist_node within the struct.
 */
...
/**
 * @brief hlist_for_each_entry_safe - iterate over list of given type safe against removal of list entry
 * @param pos	the type * to use as a loop cursor.
